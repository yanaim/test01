...
{
    public partial class frmUserAccount : frmBFForm
    {
        #region 機能概要
        /*
...
　　　　};
        ...
        public frmUserAccount(B2Com b2com)
        {
            //共通パラメータのセット
            pb2com = b2com;
       ...
       /// <summary>
        ...
        private void frmMain_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
                if (MessageBox.Show("ユーザアカウント" + "を終了します。\r\nよろしいですか？", "確認", MessageBoxButtons.YesNo,
                ...
                base.UpdateProgress(99999, "ユーザアカウントを終了します。");
        ...
        private void setSpreadInfo()
        {
            ...
            //固定列数の設定 : +1でOK
            Spread.SetFrozenColumn(fpS1.ActiveSheet, (int)SpreadColum.user_id + 1);
        ...
        #region オーバーライドファンクション
        //--------------------------------------------------------
        // Base Form に組み込まれているファンクション
        //--------------------------------------------------------
        /// <summary>
        /// 検索
        /// </summary>
        ...
        public override void kensaku(string keyField, string key)
        {
            _keyField = keyField;
            _key = key;
        ...
        /// 終了
        /// </summary>
        public override void kinou_exit()
        {
            normalExit();
            return;
        }
        ...
        /// キャンセル
        /// </summary>
        public override void kinou_cancel()
        {
            cancelExit();
            return;
        }
        ...
        public override void UpdateProgress(int commandNumValue, string commandStringValue)
        {
        ...
        #region ボタンコントロール
        private void gcTxtNew_Click(object sender, EventArgs e)
        {
            addRow();
        }

        private void gcTxtNew_DoubleClick(object sender, EventArgs e)
        {
            addRow();
        }

        private void gcTxtModify_Click(object sender, EventArgs e)
        {
            modifyData();
        }

        private void gcTxtModify_DoubleClick(object sender, EventArgs e)
        {
            modifyData();
        }

        private void gcTxtDelete_Click(object sender, EventArgs e)
        {
            deleteRow();
        }

        private void gcTxtDelete_DoubleClick(object sender, EventArgs e)
        {
            deleteRow();
        }

        private void gcTxtPdf_Click(object sender, EventArgs e)
        {
            pdfOutput();
        }

        private void gcTxtPdf_DoubleClick(object sender, EventArgs e)
        {
            pdfOutput();
        }

        private void gcTxtCsv_Click(object sender, EventArgs e)
        {
            csvOutput();
        }

        private void gcTxtCsv_DoubleClick(object sender, EventArgs e)
        {
            csvOutput();
        }

        private void gcTxtDownload_Click(object sender, EventArgs e)
        {
            downloadData();
        }

        private void gcTxtDownload_DoubleClick(object sender, EventArgs e)
        {
            downloadData();
        }

        private void gcTxtClear_Click(object sender, EventArgs e)
        {

        }

        private void gcTxtClear_DoubleClick(object sender, EventArgs e)
        {

        }

        private void gcTxtUpdate_Click(object sender, EventArgs e)
        {
            updateData();
        }

        private void gcTxtUpdate_DoubleClick(object sender, EventArgs e)
        {
            updateData();
        }
        ...
        private void gcTxtExit_DoubleClick(object sender, EventArgs e)
        {
            normalExit();
        }
        // メニュー（ファンクションに対応した処理）
        ...
        private void addRow()
        {
            try
            {
                ...
                //スプレッドの最下行にフォーカスをあてる
                Spread.SetCellFocus(fpS1, (fpS1.ActiveSheet.RowCount - 1), (int)SpreadColum.user_id);
        ...
        private void selectData()
        {
            try
            {
                ...
                //データの読込
                dbc.UserAccount.Where(x => x.YakkyokuCode == _key).OrderBy(x => x.UserId).Load();
        ...
        private void csvOutput()
        {
            try
            {
                ...
                // スプレッドの内容を取得
                //------------------
                lstrCsvDetail = Spread.SheetViewToCsv(fpS1.ActiveSheet);
